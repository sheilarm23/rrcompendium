...
completeSeqs <- which(! grepl("sp.", fastaNames))              # selecting those with specific name in them       # 562
...
alignmentFasta <- read.fasta(file = "../data/raw_data/Sicydium_COI_lengths.fasta", seqtype = "DNA", as.string = TRUE, forceDNAtolower = FALSE)

length(alignmentFasta)

myClustalOmegaAlignment <- msa("alignmentFasta", type = "DNA", "ClustalOmega")

print(myClustalOmegaAlignment, showConsensus=FALSE, halfNrow=3)
print(myClustalOmegaAlignment, showNames=FALSE, show="complete")



### Removing most duplicated sequences
