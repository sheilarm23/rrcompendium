...
tree2 <-ggtree(tree, size = .4) + 
  ...
  geom_cladelabel(node=206, label="Sicydium plumieri", color="red", hjust = -0.07, fontsize = 3.5, offset = 0.002, fontface="italic") + 
  geom_cladelabel(node=113, label="Sicydium brevifile", color="blue", hjust = -0.07, fontsize = 3.5, offset = 0.002, fontface="italic") + 
  geom_cladelabel(node=307, label="Sicydium salvini", color="purple", hjust = -0.07, fontsize = 3.5, offset = 0.002, fontface="italic") + 
  geom_cladelabel(node=314, label="Sicydium punctatum", color="brown", hjust = -0.07, fontsize = 3.5, offset = 0.002, fontface="italic") + 
  geom_cladelabel(node=363, label="Sicydium buscki", color="black", hjust = -0.07, fontsize = 3.5, offset = 0.002, fontface="italic") + 
  geom_cladelabel(node=312, label="Sicydium crenilabrum", color="orange", hjust = -0.07, fontsize = 3.5, offset = 0.004, fontface="italic") + 
  geom_hilight(node=369, fill="green") + 
